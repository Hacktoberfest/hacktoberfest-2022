export const events = [
  {
    title: 'From Code to Community: Hacktoberfest 2024 Begins!',
    content:
  ...
  },
  {
    ...
    content:
      'Join us for an exciting in-person meetup in Bengaluru as part of Hacktoberfest 2024, hosted by DigitalOcean! This event brings together developers, tech enthusiasts, and open-source advocates to connect, collaborate, and learn from one another in an interactive, hands-on sessions',
    location: 'Virtual',
    date: 'Oct 10',
  ...
  {
    title: 'Closing the Hack: Hacktoberfest 2024 Finale and Highlights',
    content:
      'Join us on October 31st for the Hacktoberfest 2024 virtual wrap-up session, where we celebrate a month of coding, collaboration, and community. This finale event brings together speakers, participants, and contributors from around the globe to reflect on the achievements, share insights, and look forward to the future of open source.',
    location: 'Virtual',
    date: 'Oct 31',
    time: '',
    rsvp: {
