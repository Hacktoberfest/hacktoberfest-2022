...
export const organizeDisclaimer = {
  content:
    'Go to [Major League Hacking](https://hackp.ac/hacktoberfest-organizehq) to set up your event and share it with the community.\n\n' +
...
export const resources = {
  ...
  sections: [
    ...
    },
    {
      ...
      collapsed: true,
      content:
        '- Post your event on the Major League Hacking [Hacktoberfest Events page](https://hackp.ac/hacktoberfest-organizehq).\n' +
    ...
    },
    {
      ...
      content:
        'Logos, banners, and more! We kindly ask that you adopt [Hacktoberfest brand guidelines](/events/#brand) as you share your meetup/content.',
      links: [
        {
