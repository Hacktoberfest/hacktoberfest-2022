...
export const advocate = [{
    ...
    title: 'Cloudflare',
    content: "Cloudflare, Inc. is the leading connectivity cloud company on a mission to help build a better Internet. It empowers organizations to create an application modernization and AI strategy to consume, build, protect, and defend at scale. Cloudflare's developer platform gives you a rich ecosystem of foundational technology built on open source and open standards. Your architecture choices shouldn't be tied to a single vendor ecosystem. When you have the freedom to choose, you're freed from costly cloud bills, sys-admin challenges, and configuration hassles freeing you to build the next big thing.",
    link: {
        target: '_blank',
        rel: 'noreferrer noopener',
...
export const partners = [{
    ...
    },
    {
        ...
        title: 'GitLab',
        content: 'GitLab is the most comprehensive AI-powered DevSecOps platform for software innovation. GitLab enables organizations to increase developer productivity, improve operational efficiency, reduce security and compliance risk, and accelerate digital transformation. More than 30 million registered users and more than 50% of the Fortune 100 trust GitLab to ship better, more secure software faster. Join 4,000+ contributors in GitLab’s open source community.\n' +
    ...
    },
    {
        ...
        title: 'CNCF',
        content: 'CNCF is the open source, vendor-neutral hub of cloud native computing, hosting projects like Kubernetes and Prometheus to make cloud native universal and sustainable.\n' +
    ...
    },
    {
        ...
        title: 'DEV',
        content: 'DEV is a community of software developers getting together to help one another out. The software industry relies on collaboration and networked learning, and DEV provides a place for that to happen.\n' +
