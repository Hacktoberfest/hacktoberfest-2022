...
import globe from 'assets/img/icons/icon-pixel-globe.svg';
import thumbsUp from 'assets/img/icons/icon-pixel-thumbs-up.svg';
import users from 'assets/img/icons/icon-pixel-users.svg';
  ...
  sections: [
    {
      ...
      items: [
        {
          content: 'Introduction to GitHub and Open-Source Projects',
          link: 'https://www.digitalocean.com/community/tutorial_series/an-introduction-to-open-source',
        },
        {
          content: 'How to Contribute to Open Source',
          link: 'https://opensource.guide/how-to-contribute/',
        },
        {
          content: 'What is Open Source',
          link: 'https://www.digitalocean.com/community/tutorials/what-is-open-source',
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          content: '[GitHub] Participating Hacktoberfest projects',
          link: 'https://github.com/topics/hacktoberfest',
        },
        {
          content: '[GitLab] Participating Hacktoberfest projects',
    ...
    },
    {
      ...
      items: [
        {
          content: '[GitHub] GitHub Training Manual',
          link: 'https://github.github.com/training-kit/',
        },
        {
          content: '[GitHub] Understanding the GitHub Flow',
          link: 'https://guides.github.com/introduction/flow/',
        },
        {
          content: '[GitLab] Learn GitLab with tutorials',
          link: 'https://about.gitlab.com/get-started/',
        },
        {
          content:
            '[General] How open source contributions can boost your career',
        ...
        {
          content: '[General] How to write a good commit message',
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        {
          content:
            '1. Found a repository that goes against the values of Hacktoberfest? [Let us know and we’ll take a look.](/report)',
        },
      ],
    },
    {
      ...
      items: [
        {
          content: `1. PR/MRs that are labeled with a label containing the word “**spam**” by maintainers will not be counted.\n
...
3. Any user with two or more spammy PR/MRs will be disqualified.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          content:
            '1. Your PR/MR must not be a draft to be considered accepted.\n\n' +
            '2. If your PR/MR is being accepted for Hacktoberfest via an overall approving review it must also not be closed.\n\n' +
            `3. Your PR/MR must be accepted by a maintainer before Hacktoberfest ends on **${trackingEndDate}** (in any time zone, UTC-12 thru UTC+14) to be counted.`,
        },
      ],
    },
    {
      ...
      items: [
        {
          content:
            '1. We continually evaluate all of the checks until your PR/MR completes the seven-day review period, except the **[participating]** check which is a one-time check. If it fails any of these checks during this time, the seven day timer will reset.\n\n' +
            ...
            `3. PR/MRs that are passing all checks and are still in the review period on ${trackingEndDate} can continue the seven-day review period into ${trackingEndExtendedMonth}.`,
        },
      ],
    },
  ],
  ...
  sections: [
      ...
      questions: [
        {
          ...
          answer: `Yes, all pull/merge requests created between ${trackingStartDate} and ${trackingEndDate} will count, regardless of when you register for Hacktoberfest.`,
        },
        {
        ...
        {
          question:
            'Do multiple pull/merge requests to the same repository count?',
          answer: 'Yes, each pull/merge request will count separately.',
        },
        {
          question: 'Do issues/commits count?',
          answer: 'No, only pull/merge requests count.',
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: 'Why organize a Hacktoberfest-themed event?',
          answer:
        ...
        {
          question: 'Who can organize a Hacktoberfest-themed event?',
          answer:
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            'As a maintainer, how should I handle spam pull/merge requests?',
          answer:
