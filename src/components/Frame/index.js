...
const Frame = ({ color = 'gold' }) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M110 220L100 220L100 230L110 230L110 220Z"
        fill={colorTheme.color4}
      />
      <path
        d="M120 220L110 220L110 230L120 230L120 220Z"
        fill={colorTheme.color4}
      />
      <path
        d="M130 210L120 210L120 220L130 220L130 210Z"
        fill={colorTheme.color2}
      />
      <path
        d="M180 210L170 210L170 220L180 220L180 210Z"
        fill={colorTheme.color4}
      />
      <path
        d="M140 220L130 220L130 230L140 230L140 220Z"
        fill={colorTheme.color4}
      />
      <path
        d="M190 220L180 220L180 230L190 230L190 220Z"
        fill={colorTheme.color3}
      />
      <path
        d="M220 200L210 200L210 210L220 210L220 200Z"
        fill={colorTheme.color4}
      />
      <path
        d="M230 220L220 220L220 230L230 230L230 220Z"
        fill={colorTheme.color3}
      />
      <path
        d="M150 230L140 230L140 240L150 240L150 230Z"
        fill={colorTheme.color3}
      />
      <path
        d="M60 230L50 230L50 240L60 240L60 230Z"
        fill={colorTheme.baseColor}
      />
      <path
        d="M100 220L90 220L90 230L100 230L100 220Z"
        fill={colorTheme.color3}
      />
      <path
        d="M100 210L90 210L90 220L100 220L100 210Z"
        fill={colorTheme.color2}
      />
      ...
      <path
        d="M80 230L70 230L70 240L80 240L80 230Z"
        fill={colorTheme.baseColor}
      />
      <path
        d="M220 127L220 137L230 137L230 127L220 127Z"
        fill={colorTheme.color3}
      />
      <path
        d="M220 117L220 127L230 127L230 117L220 117Z"
        fill={colorTheme.color1}
      />
      <path
        d="M230 97L230 107L240 107L240 97L230 97Z"
        fill={colorTheme.color1}
      />
      <path d="M220 77L220 87L230 87L230 77L220 77Z" fill={colorTheme.color1} />
      <path
        d="M220 137L220 147L230 147L230 137L220 137Z"
        fill={colorTheme.color2}
      />
      <path
        d="M210 147L210 157L220 157L220 147L210 147Z"
        fill={colorTheme.color4}
      />
      <path
        d="M230 127L230 137L240 137L240 127L230 127Z"
        fill={colorTheme.color1}
      />
      <path
        d="M220 157L220 167L230 167L230 157L220 157Z"
        fill={colorTheme.color4}
      />
      <path d="M20 91L20 81L10 81L10 91L20 91Z" fill={colorTheme.color4} />
      <path
        d="M10 91L10 81L0 81L-1.31134e-06 91L10 91Z"
        fill={colorTheme.color4}
      />
      ...
      <path
        d="M29.9238 171L29.9238 161L19.9238 161L19.9238 171L29.9238 171Z"
        fill={colorTheme.color4}
      />
      <path
        d="M10 191L10 181L0 181L-1.31134e-06 191L10 191Z"
        fill={colorTheme.color3}
      />
