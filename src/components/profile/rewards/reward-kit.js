    ...
    <Section>
      ...
      >
        <p>
          ...
          <b>unlocked a digital reward kit</b> from the sponsors of
          Hacktoberfest.
        </p>

        <p>
          Thank you for your contributions to open source. We hope you'll
          continue to contribute to more projects, and we hope to see you next
          year!
        </p>
