...
test('no fixture name still carries an unsplit partner', () => {
  FESTS_FIXTURES.forEach((fest) => {
    /* A Member Event's or a Pop-Up's format is stated by the API, not
       read from its name — the fixture kinds the derivation cannot
       vouch for. */
    if (fest.format === 'mlhMemberEvent' || fest.format === 'popup') return;
    assert.deepEqual(
